...
tee_mm_pool_t tee_mm_con_tsk;
tee_mm_pool_t tee_mm_con_nsp;
tee_mm_pool_t tee_mm_con_cred;
tee_mm_pool_t tee_mm_con_user_ns;
tee_mm_pool_t tee_mm_con_mnt_ns;
tee_mm_pool_t tee_mm_con_fs;
tee_mm_pool_t tee_mm_con_mount;
