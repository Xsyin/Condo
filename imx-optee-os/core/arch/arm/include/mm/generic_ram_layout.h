...
#define TEE_CONTAINER_BASE	   CFG_TEE_CONTAINER_START
#define TEE_CONTAINER_SIZE		CFG_TEE_CONTAINER_SIZE
#define TEE_CONTAINER_END		(CFG_TEE_CONTAINER_START + CFG_TEE_CONTAINER_SIZE)
#endif
